...
class Module:
    ...
    def __setattr__(self, key, value):
        ...
        # if the key already stored remove it for now (e.g. if a Parameter is replaced with e.g. int)
        ...
        if isinstance(value, (list, tuple)):
            ...
            if n_params == len(value):
                ...
                raise ValueError("Cannot mix Parameters and Modules in a sequence.")
